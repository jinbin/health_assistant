...
Page({
  ...
  gotoGeizan: function(options) {
    if (options.currentTarget.dataset.img) {
      ...
      wx.previewImage({
        current: 'https://746d-tmassistant-5275ad-1258071577.tcb.qcloud.la/images/zanshang-min.jpeg', // 当前显示图片的http链接
        urls: ["https://746d-tmassistant-5275ad-1258071577.tcb.qcloud.la/images/zanshang-min.jpeg"] // 需要预览的图片http链接列表
      })
    }
  },
        ...
        if (res.confirm) {
          ...
          if (wx.createRewardedVideoAd) {
            videoAd = wx.createRewardedVideoAd({
              adUnitId: 'adunit-2f94b65ee6e110b2'
            })
            videoAd.onLoad(() => {})
            videoAd.onError((err) => {})
